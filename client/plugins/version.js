...
export async function checkForUpdate() {
  ...
  // Inject Custom Alpha Release
  if (packagejson.version === '2.32.1a') {
    const baseRelease = releases.find((r) => r.version === '2.32.1')
    releases.unshift({
      name: 'v2.32.1a (Custom Alpha Build)',
      total: (baseRelease ? baseRelease.total : 23201) + 1,
      version: '2.32.1a',
      major: 2,
      minor: 32,
      patch: 1,
